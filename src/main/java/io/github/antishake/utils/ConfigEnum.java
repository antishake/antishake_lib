...
public enum ConfigEnum {
  ...
  SHAKE_DETECTION_THRESHOLD(45),  // Threshold to compare for shake detection
  SHAKE_DETECTION_CHECK_TIME_IN_SEC(1.0),  // To check the shake detection, number of seconds that the latest data should be considered from circular buffer
